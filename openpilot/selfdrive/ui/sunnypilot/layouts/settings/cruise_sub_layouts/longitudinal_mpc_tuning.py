...
class LongitudinalMpcTuningLayout(Widget):
  ...
  def _initialize_items(self):
    self._comfort_brake = self._opt("Comfort Brake", "LongitudinalMpcTuningComfortBrake", 150, 450, 5, 2)
    self._stop_distance = self._opt("Stop Distance", "LongitudinalMpcTuningStopDistance", 200, 1200, 50, 1)
    self._t_follow_relaxed = self._opt("Follow Time - Relaxed", "LongitudinalMpcTuningTFollowRelaxed", 100, 250, 5, 2)
    self._t_follow_standard = self._opt("Follow Time - Standard", "LongitudinalMpcTuningTFollowStandard", 100, 220, 5, 2)
    self._t_follow_aggressive = self._opt("Follow Time - Aggressive", "LongitudinalMpcTuningTFollowAggressive", 80, 180, 5, 2)
    self._x_ego_obstacle_cost = self._opt("Distance Cost", "LongitudinalMpcTuningXEgoObstacleCost", 50, 600, 25, 2)
    self._j_ego_cost = self._opt("Jerk Cost", "LongitudinalMpcTuningJEgoCost", 100, 1500, 50, 2)
    self._a_change_cost = self._opt("Acceleration Change Cost", "LongitudinalMpcTuningAChangeCost", 5000, 60000, 500, 0)
    self._danger_zone_cost = self._opt("Danger Zone Cost", "LongitudinalMpcTuningDangerZoneCost", 0, 50000, 500, 0)
    self._lead_danger_factor = self._opt("Lead Danger Factor", "LongitudinalMpcTuningLeadDangerFactor", 25, 150, 5, 2)
